...
<body>
    ...
    <div
        ...
        <form class="space-y-6" action="{{ route('proses-registrasi') }}" method="POST">
            @csrf
            <h5 class="text-xl font-medium text-gray-900 dark:text-white">Daftar Akun</h5>
            <div>
            ...
            <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                Sudah buat akun? <a href="{{ route('login') }}"
                    class="text-blue-700 hover:underline dark:text-blue-500">Login di sini</a>
            </div>
        </form>
    </div>
