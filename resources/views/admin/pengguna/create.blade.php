...
@section('content')
    <div class="p-6">
        <form action="{{ route('proses-tambah-pengguna') }}" method="POST" class="flex flex-wrap w-full gap-2">
            @csrf
            ...
            <div class="mb-5 w-2/5">
                ...
                <select name="role"
                    ...
                    <option value="pengguna" {{ 'pengguna' === old('role') ? 'selected' : '' }}>Pengguna</option>
